...
Instead:
1. Open a [GitHub Security Advisory](https://github.com/alishafiee1/rodi-ai-api/security/advisories/new) (private)
2. Or email **alishafiee1@gmail.com** (do not disclose publicly)
